  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="/Agartala" />
      </Helmet>
      <section id="header">
         <div className="card">
        <div className="card-body">
          <h5 className="card-title">Shri. Kailash Chander Meena, Airport Director</h5>
          <p className="card-text">
          <BsTelephone/><a href="tel:+03812342224">0381-2342224</a>
          <BsTelephone/><a href="tel:+9436123556">9436123556</a>
          </p>
          <p className="card-text">
          <FiMail/>apdagartala@aai.aero
          </p>
        </div>
      </div>
